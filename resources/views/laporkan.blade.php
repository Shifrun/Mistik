    ...
    <section class="section section-lg bg-gradient-default">
      <div class="container pt-lg pb-300">
        <div class="row text-center justify-content-center">
          <div class="col-lg-10">
            <h2 class="display-3 text-white">Laporkan Kebutuhan</h2>
            <p class="lead text-white">Apabila terjadi kekurangan logistik di suatu tempat terdampak bencana, gunakan form di bawah ini untuk melaporkan ke BDPB mengenai kekurangan logistik tersebut.</p>
          </div>
        </div>
      </div>
      <!-- SVG separator -->
          ...
          <div class="col-lg-8">
            ...
            <div class="card bg-gradient-secondary shadow">
              ...
              @csrf
                ...
                <div>
                  <button type="submit" name="submit" class="btn btn-default btn-round btn-block btn-lg">Kirim Laporan</button>
                </div>
              </form>
              </div>
            </div>
